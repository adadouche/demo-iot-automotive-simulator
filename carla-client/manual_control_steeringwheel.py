...
class DualControl(object):
    def __init__(self, world, start_in_autopilot, use_steering_wheel):
        ...
        if self._use_steering_wheel:
            ...
            self._steer_idx = int(self._parser.get('Racing Wheel', 'steering_wheel'))
            self._throttle_idx = int(self._parser.get('Racing Wheel', 'throttle'))
            self._brake_idx = int(self._parser.get('Racing Wheel', 'brake'))
            self._reverse_idx = int(self._parser.get('Racing Wheel', 'reverse'))
            self._handbrake_idx = int(self._parser.get('Racing Wheel', 'handbrake'))
